...
<svelte:head>
	...
	<meta property="og:image" content="/images/srirama.png" />
	...
	<meta name="twitter:image" content="/images/srirama.png" />
...
<section id="about" class="min-h-screen px-8 py-20 text-white">
